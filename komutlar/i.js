...
exports.run = async (bot, message, args) => {
  ...
  .addField("»**Botun Sahibi**", "<@602844930951479297> ")
  ...
  .addField("**» Bot Davet**", " [Davet Et](https://discord.com/oauth2/authorize?client_id=755741214590107691&scope=bot&permissions=2146958847)", )
   //
